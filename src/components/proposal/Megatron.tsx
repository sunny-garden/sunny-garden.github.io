...
import type { MegatronMood } from '../../types/proposal'

interface MegatronProps {
  className?: string
 ...
 */
const Megatron = ({ className, size = 160, mood = 'neutral', glow = false }: MegatronProps) => {
  const rawId = useId()
  ...
  return (
    <svg
      ...
      fill="none"
      role="img"
      aria-label="A robotic cat with glowing eyes"
    >
      <defs>
